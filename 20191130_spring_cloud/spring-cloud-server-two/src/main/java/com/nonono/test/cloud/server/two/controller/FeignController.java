...
import com.nonono.test.cloud.server.two.model.User;
...
public class FeignController implements FeignServiceClient {
    ...
    public String test1(@RequestParam String name) {
        return serverName + " test1 name: " + name;
    }
    ...
    public String test(@RequestParam String name) {
        System.out.println(serverName + " test5 name: " + name);
        return serverName + " test5 name: " + name;
    }
